                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <p class="text-muted mb-0">Navigasi ke berbagai sistem</p>
                                        </div>
                                        <div class="d-flex gap-2">
                                            <button type="button" class="btn btn-primary btn-lg" onclick="window.location.href='satpur.php'">
                                                <i class="fas fa-shield-alt me-2"></i>
                                                Sistem Alutsista KOSTRAD
                                            </button>
                                        </div>
                                    </div>
                                </div>
