        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box text-center">
                <a href="index.php" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="assets/images/garuda-sm.png" alt="logo-sm-dark" height="38">
                    </span>
                    <span class="logo-lg">
                        <img src="assets/images/garuda-dark.png" alt="logo-dark" height="40">
                    </span>
                </a>

                <a href="index.php" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="assets/images/garuda-sm.png" alt="logo-sm-light" height="40">
                    </span>
                    <span class="logo-lg">
                        <img src="assets/images/garuda-light.png" alt="logo-light" height="50">
                    </span>
                </a>
            </div>
